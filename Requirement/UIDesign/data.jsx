...
// Mirrors the PRD: company OKRs, key projects, departments, knowledge, agents.
...
// Industrial Design knowledge domains
...
// SkillPacks now carry full governance metadata
//   owner = 拥有该技能的部门 (dept id) — 公司平台技能用 "platform"
//   maintainer = 实际维护人 (单一负责人,出问题找 TA)
//   scope = 部门私有 / 跨部门 / 全公司 / 平台基础
//   status = 已发布 / 草稿 / 已下线
//   version = semver
const SkillPacks = [
  ...
  { id: "sp-aow", name: "奥维数据分析", dept: "industrial-design", maintainer: "市场部 / 林然", scope: "company", status: "published", version: "v3.1.0", icon: "BarChart3", input: "Excel / 报告", output: "价格带机会 / 竞品规格 / 市场洞察", uses: 134, rating: 4.2, updated: "2026-04-08" },
...
const Agents = [
  { id: "ag-finance", name: "财务视角", role: "Finance Strategist", color: "var(--role-finance)", icon: "Coins", focus: "ROI / 现金流 / 投入产出比" },
  { id: "ag-product", name: "产品视角", role: "Product Lead", color: "var(--role-product)", icon: "Package", focus: "用户价值 / 品类机会 / 路线图" },
  { id: "ag-gtm", name: "GTM 视角", role: "Go-to-Market", color: "var(--role-gtm)", icon: "Megaphone", focus: "渠道 / 节奏 / 竞争反应" },
  { id: "ag-ops", name: "运营视角", role: "Operations", color: "var(--role-ops)", icon: "Activity", focus: "执行节奏 / 资源 / 流程" },
  { id: "ag-risk", name: "风险视角", role: "Risk & Compliance", color: "var(--role-risk)", icon: "Shield", focus: "合规 / 安全 / 反对意见" },
  { id: "ag-tech", name: "技术视角", role: "Engineering", color: "var(--role-tech)", icon: "Cpu", focus: "可行性 / 架构 / 投入" },
  { id: "ag-supply", name: "供应链视角", role: "Supply Chain", color: "var(--role-supply)", icon: "Truck", focus: "产能 / 库存 / 供应商" },
  { id: "ag-org", name: "组织视角", role: "Org & Talent", color: "var(--role-org)", icon: "Users", focus: "组织 / 人才 / 文化" }
];

// Strategic question + War Council mock for Strategy Studio
...
Object.assign(window, {
  ...
  KnowledgeDomains, SkillPacks, SKILL_SCOPES, SKILL_STATUSES, KnowledgeSources,
  Agents, StrategyQuestion, DebateMessages, Decisions, Activity
});
