// Velocity OS — shared icons + small primitives. (Hand-rolled SVGs, lucide-style.)
// All icons accept size + className.
...
// ===== Spark line ===========================================================
function Spark({ data, color = "var(--vel-indigo)", w = 70, h = 28 }) {
...
// ===== Progress bar =========================================================
function Progress({ value, status = "ok", height = 6 }) {
  const colors = {
...
// ===== Avatar group =========================================================
function Avatar({ name, size = 24, color, style }) {
...
// expose
Object.assign(window, { Icon, Spark, Progress, Avatar, HealthPill });
